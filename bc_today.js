...
// This is a variable called thisDate assigned to a new Date object.
var thisDate = new Date("October 12, 2018");

// This is a variable that contains the string value of thisDate.
var dateString = thisDate.toLocaleString();

// This is a variable called dateHTML that concatenates two text strings with the dateString variable.
var dateHTML = "<h2>" + dateString + "</h2>";

// This is a variable called thisDay that is assigned to the specific day of the date.
var thisDay = thisDate.getDay();

// This runs the getEvent function using the thisDay variable as a value for the parameter.
